...
async function vickers(data) {
    ...
    try {
        ...
        return ["Vikers", client, data["Email"], username, password, isSucessful];
    } catch (error) {
        console.error(`Error: ${error.message}`);
        return ["Vikers", client, data["Email"], username, password, "no"];
    }

    // return ["Vickers", data["Email"], data["LastName"], "P@ssw0rd123123", "yes"];
}


module.exports = vickers;